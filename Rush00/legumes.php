...
?>
	...
	<body>
		<div class="wrapper">
			...
			<div class="five">
				<a href="./templates/tools.php?article=1"><img src="./img/tomate.jpeg" class="images"></a>
			</div>
			<div class="six">
					<a href="./templates/tools.php?article=1"><img src="./img/carotte.jpeg" class="images"></a>
			</div>
			<div class="sept">
